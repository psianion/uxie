...
// GuildMessages (owner @-mention messageCreate) + MessageContent (PRIVILEGED — toggled in the dev
// portal) ONLY. NO DirectMessages, NO GuildMembers — minimum attack surface. Partials
// Channel + Message so the mention handler receives uncached payloads. allowedMentions
